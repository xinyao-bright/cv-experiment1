...
3. 掌握无独立显卡环境下 PyTorch CPU 版本的安装方法。
...
2. 在已经激活的 `cv` 虚拟环境中执行 CPU 版 PyTorch 安装命令。
...
![图3 conda list torch 输出](assets/5.png)
...
**图4　PyTorch CPU 版本验证运行截图**

![图4 PyTorch CPU 版本验证运行截图](assets/3.png)
